...
const selectClass =
  'rounded-lg border border-[var(--mm-border-default)] bg-[rgba(14,40,65,0.04)] px-3 py-1.5 text-xs text-foreground outline-none transition-colors hover:border-[var(--mm-border-hover)] focus:border-[var(--mm-border-active)]'
